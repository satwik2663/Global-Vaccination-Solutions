 ...
 * @author raunak
 */
public class RequestDoctorByOrphaJPanel extends javax.swing.JPanel {
     ...
     */
    public RequestDoctorByOrphaJPanel(JPanel userProcessContainer, Enterprise enterprise, Network network, UserAccount userAccount) {
        initComponents();
    ...
    public void populateRequestTable() {
        ...
        for (WorkRequest request : userAccount.getWorkQueue().getWorkRequestList()) {
            ...
            row[0] = ((DoctorByOrgWorkRequest) request).getdoctorName();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 150, 1010, 110));
        ...
        add(CommentsTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 350, 530, 30));
        ...
        add(RequestingDateTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 310, 150, 30));

        enterpriseLabel1.setFont(new java.awt.Font("Broadway", 1, 24)); // NOI18N
        enterpriseLabel1.setText("Request Physician by Orphanage");
        add(enterpriseLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 40, 550, 60));
    ...
    private void SubmitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitButtonActionPerformed
        ...
        if (reqDate == null) {
            ...
            DoctorByOrgWorkRequest request = new DoctorByOrgWorkRequest();
